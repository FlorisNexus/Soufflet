// notes.ts — central mapping between MIDI note numbers, French names, and Boomwhacker colors
...
/** Returns the French name for a MIDI note (e.g. 60 → "Do", 61 → "Do#") */
...
/** Returns the octave number for a MIDI note (60 = Do4 → octave 4) */
